...
// import MoodResults from './MoodResults'; // Import MoodResults component
...
//   const [moodSums, setMoodSums] = useState({});
//   const [positiveMoodSums, setPositiveMoodSums] = useState({});
//   const [negativeMoodSums, setNegativeMoodSums] = useState({});
...
//   const calculateMoodSums = (data) => {
//     const moodSums = {};
//     const positiveMoodSums = {};
//     const negativeMoodSums = {};

//     moods.forEach(mood => {
//       moodSums[mood.id] = 0;
//       positiveMoodSums[mood.id] = 0;
//       negativeMoodSums[mood.id] = 0;
//     });

//     data.forEach(entry => {
//       moods.forEach(mood => {
//         moodSums[mood.id] += entry[mood.id];
//         if (entry[mood.id] > 0) {
//           positiveMoodSums[mood.id] += entry[mood.id];
//         } else {
//           negativeMoodSums[mood.id] += entry[mood.id];
//         }
//       });
//     });

//     setMoodSums(moodSums);
//     setPositiveMoodSums(positiveMoodSums);
//     setNegativeMoodSums(negativeMoodSums);
//   };
...
//           <MoodResults moodSums={moodSums} positiveMoodSums={positiveMoodSums} negativeMoodSums={negativeMoodSums} />
//         </div>
//       </div>
//     </div>
//   );
